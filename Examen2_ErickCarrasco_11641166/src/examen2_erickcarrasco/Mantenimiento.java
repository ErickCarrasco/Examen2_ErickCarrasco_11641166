...
public class Mantenimiento {
    ...
    public Mantenimiento(String id, String nombre, String segundonombre, String apellido, String segapellido, String password, String birthdate, String affilation) {
        this.id = id;
        this.nombre = nombre;
